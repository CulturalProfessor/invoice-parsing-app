...
def extract_text_from_pdf(pdf_path, output_dir):
    images = convert_from_path(pdf_path, dpi=400, output_folder=output_dir, fmt="png")
    ...
    for i, image in enumerate(images):
        ...
        # Use custom Tesseract configuration to improve text extraction
...
if __name__ == "__main__":
    input_pdf_dir = ["./downloads/Reciept", "./downloads/eyewear"]
